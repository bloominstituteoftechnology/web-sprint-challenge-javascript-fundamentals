...
zooAnimals.forEach(animal =>{
  var listString = `Name: ${animal.animal_name}, Scientific: ${animal.scientific_name}.`;
  displayNames.push(listString);
});
...
The zoos are concerned about animals with a lower population count. Using filter, create a 
new array of objects called lowPopulationAnimals which contains only the animals with a population less than 5.
...
population from all the zoos using the .reduce() method. Remember the reduce method takes two arguments: 
