...
const lowCaseAnimalNames
 ...
 lowCaseAnimalNames = zooAnimals.map(  e => {e.animal_name.toLowerCase()}) ;
...
lowPopulationAnimals = zooAnimals.filter(  (e) => { return e.population < 5 }  )
...
populationTotal = zooAnimals.reduce(  cb2, 0 );
