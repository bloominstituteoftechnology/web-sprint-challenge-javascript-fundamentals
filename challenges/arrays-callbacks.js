...
*/
const displayNames2 = [];
zooAnimals.forEach(animal => displayNames2.push(`Name: ${animal.animal_name}, Scientific: ${animal.scientific_name}`));
console.log(displayNames2);



const lowerCase2 = [];
zooAnimals.map(zooAnimal => lowerCase2.push(zooAnimal.animal_name.toLowerCase()));
...
const populationTotal2 = zooAnimals.reduce((acc,val) => {
  return acc + val.population;
 },0);
