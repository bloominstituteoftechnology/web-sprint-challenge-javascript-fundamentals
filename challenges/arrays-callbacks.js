...
const displayNames = []
zooAnimals.forEach(animal => displayNames.push(`Names: ${animal.animal_name} Scientific: ${animal.scientific_name}`))

console.log(displayNames)
//return `Name: ${names} Scientific Name: ${scientific}`
...
*/
let populationTotal = zooAnimals.reduce(function(totalAnimals, item){
