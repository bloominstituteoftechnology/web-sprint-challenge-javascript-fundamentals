...
let populationTotal = 0;
let animalPopulations = zooAnimals.map(zooAnimal => zooAnimal.population);
let totalPopulation = animalPopulations.reduce((acc, currentPopulation) => acc + currentPopulation, populationTotal);
