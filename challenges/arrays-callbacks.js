...
function lowCaseAnimalNames(){
  ...
  zooAnimals.map((matches) => {
    temp.push(matches.animal_name);
  });
  for(let i = 0; i < temp.length; i++){
    lowCaseAnimalNames.push(temp[i].toLowerCase());
  }
...
The zoos are concerned about animals with a lower population count. Using filter, create a new array of objects called lowPopulationAnimals which 
