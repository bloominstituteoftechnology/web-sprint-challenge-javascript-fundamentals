...
// let cuboid = CuboidMaker == {length: 4, width: 5, height: 5};

// let cuboid = Object.create(CuboidMaker, {
//   this:length = 4,
//   this:width = 5,
//   this:height = 5,
// });

// Object.create(CuboidMaker == []);
// function cuboid(){
//   this.length = 4;
//   this.width = 5;
//   this.height = 5;
...
// Cuboid = Object.create(CuboidMaker.prototype);
// function Cuboid(){
//   this.length = 4;
//   this.width = 5;
//   this.height = 5;
