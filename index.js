...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(array){
    /*Your Code Here*/
    const smallNames = array.map((item)=> item.animal_name.toLowerCase());
    return smallNames;
  ...
  */
  ...
  function USApop(array){
    /*Your Code Here*/
    const population = array.reduce((total, item) => {return total + item.population},0);
    return population;
...
*/
function CuboidMaker(itemLength, width, height){
  /*Your Code Here */
...
CuboidMaker.prototype.calcVolume = function(){
  return this.itemLength * this.width * this.height;
}
...
CuboidMaker.prototype.surfaceArea = function(){
  return 2 * ((this.itemLength * this.width) + (this.itemLength *this.height) + (this.width * this.height));
}
...
class CuboidMakerTwo{
  constructor(itemLength, width, height){
    this.itemLength = itemLength;
    this.width = width;
    this.height = height;
  }
