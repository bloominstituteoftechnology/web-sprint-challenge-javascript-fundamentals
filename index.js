...
console.log(summation(5)); // Outputs 15
console.log(summation(10)); // Outputs 55
  ...
  */
  ...
  function animalNames(zooAnimals) {
    ...
    zooAnimals.forEach(animal => {
      console.log(animal.animal_name, animal.scientific_name);
  ...
  */
  function lowerCaseNames(zooAnimals) {
    return zooAnimals.map(animal => {
      console.log(animal.animal_name); // add this line to check for undefined or incorrect spelling
      return animal.animal_name ? animal.animal_name.toLowerCase() : '';
    });
  }
