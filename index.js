...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀:
// nestedFunction can access the variable internal because it is nested inside the local scope.
...
// adding from the last number down since we don't have an array of numbers to go through.
...
function USApop() {
  return zooAnimals.reduce((total, pop) => {
