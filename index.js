...
//The function called nestedFunction console.log's internal which then the function itself has to look outside its scope to find "internal". Within myFunction, internal is present and will yield the string attached. However, is invoking myFunction, that function will console.log external and go outside of its scope to find "external". It does and it yields the attached string. That is closure, the ability for a function to go outside of its scope to find what it needs process the code (if available)
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(){
    const animalsNamesLowerCase = zooAnimals.map(function(item){
      return item.animal_name.toLowerCase()
    })
    return animalsNamesLowerCase
  }
  ...
  */
  ...
  function lowPopulationAnimals(){
    const smallPopulationAnimals = zooAnimals.filter(function(item){
      return item.population < 5
    })
    return smallPopulationAnimals
  }
