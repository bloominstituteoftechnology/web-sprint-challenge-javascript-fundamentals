...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// The nested function can reach the varible internal because of closure, closure allows nested functions to reach out to their parent functions scope and pull things downward, like inheritance.
...
const zooAnimals = [
 ...
 function animalNames(array){
  const animalNamez = [];
   array.forEach(function(item){
    animalNamez.push(`Name: ${item.animal_name}, Scientific: ${item.scientific_name}`);
 });
 return animalNamez;
}
  ...
  */
  function USApop(array){
    const reduce = array.reduce(function(accumulator, item){
