...
function summation(summation) {
  if('summation returns a number') ()=>{
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(displayNames){
    if('displayNames returns a number');()=>{
      expect(functions.displayNames(zooAnimals)).toEqual(expect.arrayContaining(
