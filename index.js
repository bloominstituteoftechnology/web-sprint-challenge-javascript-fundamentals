...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
/*
nestedFunction can access myFunction because nestedFunction is still a part of myFunction. myFunction can't access any variables in nestedFunction however.
*/
...
animalNames();
  ...
  */
  ...
  function lowerCaseNames(){
    let namearr = [];
    zooAnimals.map(i => namearr.push(i.animal_name.toLowerCase()));
    console.log(namearr);
    return namearr;
  }
  lowerCaseNames();
  ...
  */
  ...
  function lowPopulationAnimals(){
    //let poparr = [];
    let poparr = zooAnimals.filter(i => i.population < 5);
    console.log(poparr);
    return poparr;
  }
lowPopulationAnimals();
  ...
  */
  ...
  function USApop(){
    let poptotal = [];
    zooAnimals.map(i => poptotal.push(i.population));
    const total = poptotal.reduce((a, b) => a += b,0);
    console.log(total);
    return total;
  }
USApop();
