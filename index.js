...
//The nested function can look outside of itself because of the function scoping.
...
function animalNames(){
  ...
  */
  ...
  function lowPopulationAnimals(){
    let endangeredAnimals = zooAnimals.filter(function(item){
...
function Child(childAtt){
 CuboidMaker.call(this, childAtt);
}
