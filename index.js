...
// The nestedFunction can access the internal variable because both the nested function and internal variable are within the myFunction function.
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(zooAnimals){
    return zooAnimals.map(function(e){
...
//CubeMaker.  Find out the formulas for volume and surface area for cubes and create
//those methods using the dimension properties from CuboidMaker.
//Test your work by logging out your volume and surface area. 🦄 💪

function CubeMaker(length, width, height) {
 ...
 CubeMaker.prototype.surfaceArea = function() {
   let squareInches = this.length * this.length;
   return squareInches + squareInches + squareInches + squareInches + squareInches + squareInches;
 }
