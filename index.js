...
//The function can access the variable internal because you can reach outside your scope for variables but never inside.
//nestedFunction() checks for internal on its own scope. When it cant find it, it checks a scope above and will continue to do so until it reaches global.
...
*/
function CuboidMaker(arguements){
  this.length = arguements.length,
  this.width = arguements.width,
  this.height = arguements.height
}
...
class CubeMaker extends CuboidMaker {
  constructor(length){
    super({width:length, length:length, height:length})
  }
  volume(){
...
console.log("Cube surface: " + cube.surfaceArea())
