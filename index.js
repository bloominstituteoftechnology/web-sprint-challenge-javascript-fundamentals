...
// Given this zoo data from around the United States, follow the instructions below. Use the specific array methods in the requests below to solve the problems.
  ...
  */
  ...
  function USApop (zooAnimals) {
    const popCount = zooAnimals.reduce((accumulator, zooAnimal) => accumulator + zooAnimal["population"], 0 )
    return(popCount)
  }
  console.log(USApop)
...
/* 🐴🐴🐴 Step 4: Create a new object that uses CuboidMaker 🐴🐴🐴
  ...
  function CuboidMaker (length, width, height){
    ...
    CuboidMaker.prototype.surfaceArea = function(){
      const sufArea = 2 * (this.length * this.width + this.length * this.height + this.width * this.height) 
      return sufArea;
    }
  }
...
/* yeah idk whats going on here but i tried but gave up */
...
console.log(Cubey.volume()); // expecting 64
console.log(Cubey.surfaceArea()); //expecting 96
