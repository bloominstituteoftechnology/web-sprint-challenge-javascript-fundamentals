...
const { arrayPattern } = require("@babel/types");
...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// It can be accessed because nestedFunction is a child function and has access to every thing in the parent function myFunction including the variable internal.
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(number){
    const totalPop = number.reduce (function(acc,item){
  ...
  */
  function consume (num1, num2, numCb){
    return numCb (num1, num2);
...
function greeting(num1, num2){
  ...
  console.log('step 2',consume(2, 2, add)); // 4
  console.log('step 2',consume(10, 16, multiply)); // 160
  console.log('step 2',consume("Mary", "Poppins", greeting)); // Hello Mary Poppins, nice to meet you!
