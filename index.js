...
//nestedFunction can access the varible internal because it is being told to look out side the fuction it is in to find the answer. nestedFucntion() calls for the nestedFunction to run and then the console.log inside function nestedFunction calls for internal which is not inside the function so it look out and finds internal on the outside of the function
