...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀:
// they are both in the my function scope which ends when the function ending bracket is placed meaning they are in the same scope. Also the function nested can look out side its scope and use other variables how nothing that is not inside can com from the out side and add to the function. you have to call or refernce for that.
...
//     displayNames.push(
//       `name: ${anArray[i].animal_name}, scientific: ${anArray[i].scientific_name}`
//     );
//   }
// }

// function animalNames(anArray) {
//   anArray.forEach(myFunction);
//   let displayNames = [];
