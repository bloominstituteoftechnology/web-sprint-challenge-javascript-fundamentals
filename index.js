...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// The nested function can access "internal" because the nested function is inside of myFunction()'s closure/lexical scope.
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(names){
    /*Your Code Here*/
    let displayNames = [];
    names.forEach(function(animalparam){
      displayNames.push(`name: ${animalparam.animal_name}, scientific: ${animalparam.scientific_name}`);
    });
    return displayNames;
  }
  ...
  */
  ...
  function USApop(zooAnimals){
    /*Your Code Here*/
    let reducerfunction = function(accumulator, animal) {
      return accumulator + animal.population;
    }
    return zooAnimals.reduce(reducerfunction, 0);
  }
