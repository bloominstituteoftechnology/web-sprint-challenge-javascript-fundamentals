...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// you can pull variables from outside of a function. since nestedFunction is inside of myFunction and myFunction has the variable internal, nestedFucntion is able to use it. if nestedFunction was OUTSIDE of myFunction, it would not be able to use internal because it is inside of myFunction. 
...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(arr){
    let animalPop = [];
    let pop = arr.filter(function (animals){
  ...
  */
  ...
  function USApop(arr){
    const totalPop = arr.reduce(function (accumulator, animals){
