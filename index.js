...
//For nestedfunction the variable internal is outside the function so it is like global scope.
...
console.log(lowerCaseNames(zooAnimals));
 ...
 function lowPopulationAnimals(data){
  let lowPop = data.filter(data => data.population < 5);
  return lowPop;
}
...
console.log(multiply(3,5,));
 ...
 console.log(greeting("Yonathan","Admasu"));
