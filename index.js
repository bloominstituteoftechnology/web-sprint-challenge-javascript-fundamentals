...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// nestfunction can access 'internal' because they are within the same scope which in this case is the same function scope of 'myFunction'.
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(){
    ...
    return populations.reduce((acc, cur) => {
      return acc + cur;
    }, 0);
  }
