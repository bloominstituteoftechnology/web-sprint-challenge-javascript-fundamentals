...
5. Why do we need super() in an extended class?
    We call 'super' everytime we call and access functions on an object's parent.
...
* [missed] Find this challenge in the index.js file. Read the instructions carefully!
