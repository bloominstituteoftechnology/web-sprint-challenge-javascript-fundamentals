...
.for each loops through each element of an array but  doesnt return anything. map loos through each element of an array , applying a function to each element and returning a new array 
